...
export const drawShape = (shape: Shape, drawSpinIcon: boolean = false) => {
    if (!shape) return;
...
export const draw = (
    ...
    !bomb.bombMode && drawShape(currentShape as Shape, drawSpinIcon);
